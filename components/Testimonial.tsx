...
export default function Testimonial({ quote, author, role }: TProps) {
  return (
    <figure className="rounded-3xl border border-brand-aqua/30 bg-black/40 backdrop-blur-sm p-8 shadow-soft transition-all duration-300 hover:shadow-xl hover:bg-black/60 text-brand-pearl">
